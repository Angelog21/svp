...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        ->each(function(Office $o){
            ...
            factory(Person::class,1)->create(['name'=>'alexey rojas', 'card_id'=>'59876542', 'extension'=>'1234','phone'=>'04261234567','date_admission'=>'2010-11-28'])
            ->each(function(Person $p){
        ...
        factory(Person::class, 1)->create(['name'=>'Jonny Rojas', 'card_id'=>'28454562', 'extension'=>'1234','phone'=>'04261234567','date_admission'=>'2015-08-25'])
        ->each(function (Person $p){
